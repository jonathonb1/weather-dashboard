...
$(document).ready(function () {
    ...
    function searchWeather(cityName) {
        ...
        $.ajax({
            type: "GET",
            url: `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=688988e3b9c619e778927f53f7761d5d&units=imperial`
    ...
    function getForecast(cityName) {
        $.ajax({
            type: "Get",
            url: `https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&appid=688988e3b9c619e778927f53f7761d5d&units=imperial`
        }).then(function (response) {
